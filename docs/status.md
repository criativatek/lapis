...
| **Aulas e Sumários — Fatia 2 de 6** | 🚧 | `/lessons` é agora a página operacional real (vista semanal com navegação, todas as turmas do professor no ano letivo selecionado). Planeamento antecipado (`LessonPlan`) distinto do sumário oficial, estados Por preparar/Preparado/Lecionado, horário recorrente configurável na página da turma, materialização em lote por semana. Ainda sem notas, recursos, TPC, cumprimento, sequências, continuidade ou faltas/atrasos — ver desenho e plano faseado em [docs/superpowers/specs/2026-08-23-lessons-summaries-planning-sequences-design.md](superpowers/specs/2026-08-23-lessons-summaries-planning-sequences-design.md) e [docs/superpowers/plans/2026-08-23-lessons-summaries-planning-sequences.md](superpowers/plans/2026-08-23-lessons-summaries-planning-sequences.md). |
