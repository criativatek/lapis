...
import { CHROME_BORDER, CHROME_SURFACE_STICKY } from './chrome';
        ...
        >
            ...
            >
                <a
                    ...
                    :key="item.href"
                    :href="item.href"
                    class="group relative rounded-md px-3 py-2 text-sm font-medium text-muted-foreground transition-colors duration-300 hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none"
                >
                    {{ item.label }}
                    <span
                        aria-hidden="true"
