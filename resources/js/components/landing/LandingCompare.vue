    ...
    >
        ...
        <details class="group">
            ...
            >
                ...
                />
                <span class="group-open:hidden">Ver a tabela completa</span>
                <span class="hidden group-open:inline">Fechar a tabela</span>
            </summary>
            <div class="mt-8">
                    ...
                    >
                        <table class="w-full min-w-[40rem] text-left text-sm">
                            <caption class="sr-only">
                                Funcionalidades incluídas em cada plano do
                                Lapispro
                            </caption>
                            <thead
                ...
                <RevealOnScroll>
                    ...
                    >
                        <p v-if="hasPlanned()">
                            ...
                            >
                            assinala o que está previsto no plano e ainda não
                            está disponível na aplicação. Nada aqui é
                            apresentado como pronto antes de o estar.
                        </p>
                        <p>
                            A exportação dos seus próprios dados existe em todos
                            os planos e não tem linha nesta tabela porque não
                            depende do plano. O que a tabela assinala é a outra
                            metade: repor uma cópia de segurança completa e
                            guardar o histórico dos backups.
                        </p>
                        <p>
                            O plano Base inclui até
                            {{ BASE_ACTIVE_CLASSES }} turmas e
                            {{ BASE_ACTIVE_STUDENTS }} alunos ativos. Turmas e
                            alunos arquivados não contam para estes limites.
                        </p>
                        <p>
                            A IA do Lapispro sugere e reescreve texto — propõe
                            estratégias e ajuda a aperfeiçoar a redação de um
                            relatório. Não atribui nem decide classificações. O
                            Lapispro organiza, calcula e acompanha. O professor
                            observa, decide e ensina.
                        </p>
                    </div>
                </RevealOnScroll>
