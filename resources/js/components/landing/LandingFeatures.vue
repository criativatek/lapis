...
const stages: readonly Stage[] = [
    ...
    },
    {
        ...
        path: 'lapispro.com/classes/9b/interventions',
        label: 'Estratégias e medidas registadas para um aluno no Lapispro, com a dificuldade, o objetivo e o acompanhamento.',
    ...
    },
    {
        ...
        path: 'lapispro.com/reports/2o-periodo',
        label: 'Relatório de avaliação em edição no Lapispro, com secções compostas a partir dos dados já registados.',
