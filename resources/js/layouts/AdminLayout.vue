...
import { ArrowLeft, Banknote, LogOut, Mail, ShieldCheck, Sparkles, UserPlus, Users } from '@lucide/vue';
...
// Nav grows as backoffice slices land (accounts → create → comercial → SMTP → IA).
const nav = [
