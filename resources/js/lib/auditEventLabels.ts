...
const labels: Record<string, string> = {
    ...
    'class.activated': 'Turma ativada',
    'class.deleted': 'Turma eliminada',
    'enrollment.created': 'Aluno inscrito',
    'enrollment.updated': 'Dados do aluno corrigidos',
    'enrollment.removed': 'Aluno removido da turma',
    'enrollment.process_numbers_updated': 'N.º de processo atualizado',
    'enrollment.support_reused': 'Aluno existente adicionado a turma de apoio',
    'roster_import.confirmed': 'Lista de turma importada',
    'instrument.created': 'Elemento de avaliação criado',
    'instrument.updated': 'Elemento de avaliação alterado',
    'instrument.deleted': 'Elemento de avaliação eliminado',
    'instrument.cancelled': 'Elemento de avaliação anulado',
    'instrument.cancellation_reverted': 'Anulação revertida',
    'instrument.correction_completed': 'Correção concluída',
    'instrument.correction_reopened': 'Correção reaberta',
    'scores.recorded': 'Notas lançadas',
    'interim_assessment.created': 'Avaliação intercalar guardada',
    'interim_assessment.updated': 'Avaliação intercalar atualizada',
    'interim_assessment.deleted': 'Avaliação intercalar eliminada',
    'record.created': 'Registo criado',
    'record.updated': 'Registo atualizado',
    'record.deleted': 'Registo eliminado',
    'record.homework_batch_updated': 'Trabalho de casa guardado',
    'record.homework_batch_deleted': 'Trabalho de casa eliminado',
    'self_assessment.recorded': 'Autoavaliação registada',
    'class_group.created': 'Grupo de turma criado',
    'class_group.updated': 'Grupo de turma alterado',
    'class_group.deleted': 'Grupo de turma eliminado',
    'class_group.archived': 'Grupo de turma arquivado',
    'class_group.restored': 'Grupo de turma restaurado',
    'class_group.students_assigned': 'Alunos distribuídos por grupos',
