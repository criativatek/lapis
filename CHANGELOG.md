...
- **Fusão do ramo remoto (`origin/main`) com os 41 commits locais acumulados desde a v0.42.6.** Dois ramos de trabalho tinham avançado em paralelo sem se cruzar: `origin/main` recebeu diretamente a nova landing page comercial (abaixo, identificada como "0.43.0/0.43.1 — landing page"); o local recebeu as Fatias 5 (encerramento recuperável de conta e de organização), 6 e 6.1 (backup/restauro pedagógico completo, incluindo clonagem entre organizações), a UI de Administração Institucional (0.45.4) e a consistência pt-PT (0.45.5). Os dois ramos usaram, cada um, o número 0.43.0 para conteúdo diferente — ver a nota logo abaixo do 0.45.1. A partir desta versão a numeração volta a ser única.
...
> **Nota de fusão (2026-08-21):** as duas entradas seguintes (0.43.1 e 0.43.0 "— landing page") vinham de `origin/main`, um ramo que avançou em paralelo ao local sem se cruzarem durante quase duas semanas. O ramo local já tinha usado, de forma independente, o mesmo número **0.43.0** para outra entrega nesse intervalo — o encerramento recuperável de conta e organização, logo a seguir. Nenhum dos dois números foi reescrito: ficam ambos registados, distinguidos por rótulo, e a numeração local (0.43.0 → 0.45.6) é que continua como sequência canónica do projeto a partir daqui.

## [0.43.1] — 2026-08-21 — landing page (origin/main)
...
## [0.43.0] — 2026-08-21 — landing page (origin/main)
