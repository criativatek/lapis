 ...
 * @property-read int|null $attendances_count carregado por `withCount()` em WeeklyLessonsQuery — todas as linhas, não só as faltas; não existe fora dessa consulta
 */
